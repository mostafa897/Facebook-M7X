...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mSmostafa 7x \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        toilet -f mono12 -F border mostafa 7x
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m   whatsApp: https://wa.me/+201095262372 \e[0m"
    echo -e "\e[4;32m   YouTube: https://youtube.com/channel/UCVX_ekBS90dP7-5WImokT1g \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of m7x for more stability."
    echo " "
}
